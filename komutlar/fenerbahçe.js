...
exports.run = (client, message, args) => { 
  ...
  if(message.channel.type !== "text") return;
    ...
    moldura = Jimp.read("https://cdn.discordapp.com/attachments/593912763760508928/593955075299213325/fb.png");
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['fb', 'fenerbahçe', 'fenerbahce', "fener"],
  permLevel: 0
};

exports.help = {
  name: 'fb',
  description: `PP'nize Fenerbahçe Çerçevesi Ekler.`,
  usage: 'fenerbahçe'
};
