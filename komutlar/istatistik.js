...
• Kütüphane        :: Discord.JS v${Discord.version}`);
};

exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['bot durum', 'i', 'bi', 'istatistikler', 'kullanımlar', 'botdurum', 'bd', 'istatisik', 'stats', 'stat', 'bot'],
  permLevel: 0
};

exports.help = {
  name: 'istatistik',
  description: 'Bot İstatistiğini Gösterir.',
  usage: 'istatistik'
};